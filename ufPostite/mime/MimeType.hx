...
abstract MimeGroup(MimeType) from MimeType to MimeType{

	public static var images:Array<MimeType>=[
    ...
    public function new(a:MimeType){
        this=a;
        return this;
    }
    ...
    public function toGroup():Group{
        if (images.indexOf(this)!=-1)return IMG;
        if (video.indexOf(this)!=-1)return VID;
        if (docs.indexOf(this)!=-1)return DOC;
        return AUTRE;
    } 
   }
